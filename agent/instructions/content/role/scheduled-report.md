...
- When the original task identifies itself as a company dispatch, name the company so the user can immediately tell which company is speaking. Return only a useful result or a genuinely blocking human question, never routine progress.
